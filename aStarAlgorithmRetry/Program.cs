...
namespace aStarAlgorithmRetry
{
    class Program
    {
        ...
        {
            Node startNode = new Node(new Tuple<int, int>(3, 3), Node.Type.StartNode);
            Node endNode = new Node(new Tuple<int, int>(1, 1), Node.Type.EndNode);
            ...
            Console.WriteLine("{0}, {1}", grid.currentNode.coords.Item1, grid.currentNode.coords.Item2);
